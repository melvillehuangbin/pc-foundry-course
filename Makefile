...
deploy:
	@forge script script/DeployFundMeV2.s.sol:DeployFundMe $(NETWORK_ARGS)
...
fund:
	@forge script script/InteractionsV2.s.sol:FundFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

withdraw:
	@forge script script/InteractionsV2.s.sol:WithdrawFundMe --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)